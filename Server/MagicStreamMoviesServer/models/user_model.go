...
import (
	...
	"go.mongodb.org/mongo-driver/v2/bson" // this is used to create the bson ObjectID
)
...
// this model is a dto: data transfer object:
// It is design pattern to transfer data between software components
// It holds data only, for transfer purposes
